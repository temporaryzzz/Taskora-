            ...
            <div className="profile-card profile-card--settings">
                ...
                <div className='profile-card__section'>
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting">
                            <button className="dropdown-menu__select-btn">
                                <img src='/email-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Изменить почту
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
                    </div>
                    ...
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting">
                            <button className="dropdown-menu__select-btn">
                                <img src='/key-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Изменить пароль
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
                    ...
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting">
                            <button className="dropdown-menu__select-btn">
                                <img src='/watch-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Настройка
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
                ...
                <div className='profile-card__section'>
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting dropdown-menu--with-after">
                            <button className="dropdown-menu__select-btn">
                                <img src='/gray-priority-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Темная
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
                    ...
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting dropdown-menu--with-after">
                            <button className="dropdown-menu__select-btn">
                                <img src='/blue-priority-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Выбрать
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
                ...
                <div className='profile-card__section'>
                    ...
                    <div className='profile-card__paragraph'>
                        ...
                        <div className="dropdown-menu dropdown-menu--setting dropdown-menu--with-after">
                            <button className="dropdown-menu__select-btn">
                                <img src='/reminder-icon.svg' width={'18px'} height={'18px'} style={{marginRight: '10px', marginTop: '2px'}}></img>
                                Нет
                            </button>
                            <div className="dropdown-menu__content" style={{display: 'none'}}></div>
                        </div>
