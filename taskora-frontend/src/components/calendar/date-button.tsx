...
function DateButton(props: DateButtonProps) {
  const ChangeDate = () => {
    const newDate = new Date(
      ...
      props.date,
      props.targetDate != undefined ? props.targetDate.getHours() : 23,
      props.targetDate != undefined ? props.targetDate.getMinutes() : 59
    );
  ...
  return (
    <li className={props.elementClass} id="calendar" onMouseDown={ChangeDate}>
      {props.date}
    </li>
  );
}
